...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            model_report, best_model_name, best_model = evaluate_models(X_train=X_train,y_train=y_train,X_test=X_test,y_test=y_test,models=models,para=params)
            ...
            return f"The best model name {best_model} and score {r2_square}"
